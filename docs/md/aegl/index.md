...
这些东西累计起来, 就像一个巨大的黑洞一般, 无从下手.


#### 之后

直到此项目废弃的两年之后, WebCodecs API 发布. 后来我在闲时将这个演示的编码方式切换为此 API, 它使得编码速度提升了 10 多倍, 而且 web 端编辑和混合视频现在已经变得简单, 这个项目变得不那么遥不可及. 不过回头望去, 当初那些充满激情, 设计出这些模版的设计师们, 早已云散.
...
- 字体管理和素材管理系统, 以及提供一个平台让设计师可以上传和分享制作的模版, 以及让用户使用这些模版并且可以随时反馈.


#### 关于设计的想法

在编写 AEGL 时, 我发现通过非常简单的设计形式的组合可以产生震撼人心的效果. 但是我以及身边的人都无法解释它是怎么产生的.
